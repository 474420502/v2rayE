...
func (a *tuiApp) openCommandPalette() {
	a.runUI(func(app *tview.Application) {
		...
		a.commandPaletteInput.SetFieldTextColor(tcell.ColorWhite)
		a.commandPaletteInput.SetLabelColor(tcell.ColorLightGray)
		...
		a.commandPalette.SetMainTextColor(tcell.ColorWhite)
